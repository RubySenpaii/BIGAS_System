 ...
 * @author RubySenpaii
 */
public class MAOPerformanceBarangay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("data written for transfer to mao/performanceBarangay.jsp");
            response.getWriter().write("[" + jsonObjects.toString() + "]");
        } catch (JSONException ex) {
            Logger.getLogger(MAOPerformanceBarangay.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

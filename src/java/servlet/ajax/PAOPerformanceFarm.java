 ...
 * @author RubySenpaii
 */
public class PAOPerformanceFarm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("data written for transfer to pao/performanceFarm.jsp");
            response.getWriter().write("[" + jsonObjects.toString() + "]");
        } catch (JSONException ex) {
            Logger.getLogger(PAOPerformanceFarm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

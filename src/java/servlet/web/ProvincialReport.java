 ...
 * @author RubySenpaii
 */
public class ProvincialReport extends BaseServlet {
    ...
    private void generateReports(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
        ...
        for (int a = 0; a < municipalities.size(); a++) {
            ...
            ArrayList<PlantingReport> plantingReports = new PlantingReportDAO().getProvincialData(calculator.getYear(), municipalities.get(a).getMunicipalityName());
...
//            }
            ...
            System.out.println(damagedTotalTotal + " " + harvestedTotalTotal);

...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Municipal - Programs Completed </title>
                                        ...
                                        <table id="datatable" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/BIGAS_System/EncoderProgram?action=viewDeployedProgramDetails&deployedID=<%=ongoingDeployedPrograms.get(a).getDeployedID()%>" class="btn btn-success">
                                                            View
                                                        </a>
                                                    </td>
                                                </tr>

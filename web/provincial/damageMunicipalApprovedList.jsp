<%-- 
    Document   : damageMunicipalApprovedList
...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Provincial - Approved Damage List Per Municipal </title>
                                                ...
                                                <table id="datatable" class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%=incidents.get(a).getMunicipalityName()%></td>
                                                            ...
                                                            <td>
                                                                <a href="/BIGAS_System/ProvincialDamages?action=goToApprovedDamages&problemID=<%=incidents.get(a).getProblemReported()%>&municipalityName=<%=incidents.get(a).getMunicipalityName()%>" class="btn btn-success">
                                                                    View Detail
                                                                </a>

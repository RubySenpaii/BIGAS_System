...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Provincial - Crop Growth Monitoring </title>
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <%
                                                    double pixels = ((ArrayList<Municipality>) session.getAttribute("municipalities")).size() * 40;
                                                %>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%=new Formatter().doubleToString(municipalities.get(a).getNewlyPlantedArea()) + " ha"%></td>
                                                            <td><%=new Formatter().doubleToString(municipalities.get(a).getTilleringArea()) + " ha"%></td>
                                                            <td><%=new Formatter().doubleToString(municipalities.get(a).getReproductiveArea()) + " ha"%></td>
                                                            <td><%=new Formatter().doubleToString(municipalities.get(a).getHarvestingArea()) + " ha"%></td>
                                                        </tr>
                                                        <%
                                                            }
                                                        %>

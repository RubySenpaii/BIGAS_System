                                        ...
                                        <div class="row">
                                            <%
                                                ...
                                                if (targetProduction.getTargetValue() > totalProduction) {
                                                    ...
                                                    target = targetProduction.getTargetValue() / totalProduction * 100;
                                                }
                                            %>
                                            <div class="col-md-12">
                                                <div style="position: relative">
                                                    ...
                                                    <div class="progress">
                                                        ...
                                                        <div style="height: 20px; position: absolute; top: 0; right: 50%; color: black">
                                                            <b><%=new Formatter().doubleToString(targetProduction.getTargetValue())%> MT</b>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style="position: relative">
                                                    ...
                                                    <div class="progress">
                                                        ...
                                                        <div style="height: 20px; position: absolute; top: 0; right: 50%; color: black">
                                                            <b><%=new Formatter().doubleToString(totalProduction)%> MT</b>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="/BIGAS_System/ProvincialProgram?action=viewDeployedProgramDetails&deployedID=<%=deployedPrograms.get(a).getDeployedID()%>" class="btn btn-success">
                                                                    View
                                                                </a>
                                                            </td>
                                                        </tr>

...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Provincial - Farm Performance </title>
...
//                    categoryLinks[values[0].farms[a].farmName] = 'http://localhost:8084/BIGAS_System/ProvincialPerformance?action=viewFarmDetail&farmName=' + values[0].farms[a].farmName;
                    ...
                    plotOptions: {
                        series: {
                          ...
                          point: {
                              events: {
                                  click: function() {
                                      location.href = 'http://localhost:8080/BIGAS_System/ProvincialPerformance?action=viewFarmDetail&farmName=' + this.options.key;
                                  }
                              }
                          }
                        },

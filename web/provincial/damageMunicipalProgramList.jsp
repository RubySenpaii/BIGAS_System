<%-- 
    Document   : damageMunicipalProgramList
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="/BIGAS_System/ProvincialDamages?action=goToProgramDamages&problemID=<%=incidents.get(a).getProblemReported()%>&municipalityName=<%=incidents.get(a).getMunicipalityName()%>" class="btn btn-success">
                                                                    View Detail
                                                                </a>
                                                            </td>
                                                        </tr>

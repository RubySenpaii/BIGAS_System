                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 30%">Barangay Name</th>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ArrayList<Barangay> currentBarangays = (ArrayList<Barangay>) session.getAttribute("currentBarangays");
                                                            for (int a = 0; a < currentBarangays.size(); a++) {
                                                        %>
                                                        <tr>
                                                            ...
                                                            <td><%=new Formatter().doubleToString(currentBarangays.get(a).getMajorDamagedArea()) + " ha"%></td>
                                                        </tr>
                                                        <%
                                                            }
                                                        %>

...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Municipal - Barangay Performance </title>
                    ...
                    plotOptions: {
                        series: {
                          ...
                          point: {
                              events: {
                                  click: function() {
                                      location.href = 'http://localhost:8080/BIGAS_System/MunicipalPerformance?action=viewFarmPerformance&brgyName=' + this.options.key;
                                  }
                              }
                          }
                        },

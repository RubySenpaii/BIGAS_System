...
<html lang="en">
    <head>
        ...
        <title>B.I.G.A.S. System | Municipal - Technician Assignment </title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <%
                                    Employee technician = (Employee) session.getAttribute("technician");
                                    String techName = technician.getLastName() + ", " + technician.getFirstName();
                                %>
                                <h3>Technician Assignment - <%=techName%></h3>
                            </div>
                        </div>
                                            ...
                                            <form classs="">
                                                <div class="col-md-8 col-md-offset-2">
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" class="btn btn-success" name="action" value="editTechAssign">
                                                            Submit
                                                        </button>
                                                    </div>
                                                </div>
